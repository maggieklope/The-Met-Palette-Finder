---
title: "Exploring the Met Gallery"
author: "Maggie Klope"
date: "3/6/2019"
  ...
  tabsetPanel(
    tabPanel("Introduction", #first tab for introduction
      ...
      sidebarLayout(
        ...
        mainPanel(
          br(),
          p("Using the Metropolitan Museum of Art Open Access Initiative this Shiny App will allow you to explore the Met Collection, and even using paintings from the collection to create a color palette to inspire your own work!"),
          p(
    ...
    tabPanel("By Country and Year", #second tab
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          br(),
          helpText("Country centroid data from Frank Donnelly")
        ),
        mainPanel(
          align = "center",
    ...
    tabPanel("Acquisition by Country", #third tab
      ...
      sidebarLayout(
        sidebarPanel(
          p("Choose a country below and discore how the museum acquired the objects, be it as a gift or loan, or through a fund or purchase"),
